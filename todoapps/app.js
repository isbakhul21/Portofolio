...
class Root extends Component {
    ...
    <div>
        <div class="input-group-lg w-100 d-flex border rounded align-items-center">
            <input type="text" class="form-control-lg flex-fill border-0 me-1" placeholder="Add New Task Here !!!" 
            aria-label="Add New Task Here !!!" aria-describedby="button-addon2" t-att-value="state.name" t-model="state.name"/>
            ...
            <button class="btn btn-primary" type="button" id="button-addon2" t-on-click="addTask"><i class="bi 
            bi-plus-lg fs-3"></i></button>
        </div>
    </div>
